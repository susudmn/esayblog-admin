        ...
        <el-table ref="dataTable"
         ...
         <el-table-column v-if="options.selectType && options.selectType == 'checkbox'"
          ...
          <template v-for="(column,index) in columns">
            <template v-if="column.scopeSlots">
...
// 顶部60 内容区域距离顶部 20  内容上下内间距 15*2  分页区域高度 46
const toHeight = 60 + 20 + 30 + 46

const tableHeight = ref(
    props.options.tableHeight
        ? props.options.tableHeight
        : window.innerHeight - toHeight - props.options.extHeight
)
